...
== Disclaimer
This Ruby style guide was 99.9% lifted from https://github.com/rubocop-hq/ruby-style-guide. Some parts have been omitted to reduce reading time. Although github is an open-source community, I acknowledge that the original guide was done with genuine passion to share knowledge with the rest of the community. All that to say I don't claim ownership over any of the ideas in this guide.
